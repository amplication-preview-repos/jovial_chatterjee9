...
const service = {
  ...
  timeSeriesDataItems: () => FIND_MANY_RESULT,
  timeSeriesData: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("TimeSeriesData", () => {
  ...
  test("POST /timeSeriesData", async () => {
  ...
  test("GET /timeSeriesData/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/timeSeriesData"}/${nonExistingId}`)
  ...
  test("GET /timeSeriesData/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/timeSeriesData"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /timeSeriesData existing resource", async () => {
